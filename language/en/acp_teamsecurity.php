...
$lang = array_merge($lang, array(
	...
	'ACP_LOGIN_EMAIL_EXPLAIN'				=> 'Send an e-mail when a user logs into the ACP.',
	'ACP_CONTACT_EMAIL'						=> 'Security contact',
	'ACP_CONTACT_EMAIL_EXPLAIN'				=> 'E-mail will be delivered to this address. If left blank, e-mail will be delivered to the board contact defined in e-mail settings.',
	'ACP_CONTACT_NAME'						=> 'Security contact name',
	'ACP_CONTACT_NAME_EXPLAIN'				=> 'This is the security contact name that e-mail recipients will see in some of the outgoing e-mail notifications. This field can be left blank.',
	...
	'ACP_EMAIL_CHANGES'						=> 'Notify e-mail address changes',
	'ACP_EMAIL_CHANGES_EXPLAIN'				=> 'Send an e-mail notification when an e-mail address is changed for a member of the selected groups.',
